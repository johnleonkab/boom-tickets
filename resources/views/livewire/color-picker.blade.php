    ...
    <div>
        ...
        <div>
            <div class="flex items-center w-full">
                <div>
                    <label for="colorSelected" class="block font-medium mb-1"> Color</label>
                    <input id="colorSelected" type="text" :class="`${colorSelected}`" placeholder="Pick a color"
                        ...
                        <input type="hidden" name="color" id="color" value="{{$defaultValue}}" >
                </div>
                        ...
                        <div class="rounded-md bg-white shadow-xs px-4 py-3">
                            ...
                            <template x-for="(color, index) in colors" :key="index">
                                ...
                                >
                                    ...
                                    <template x-if="colorSelected != color">
                                        <div
                                            @click="colorSelected = color; value = values[index]; document.getElementById('color').value = value; colorEdited()"
...
<script>
    ...
    function app() {
        return {
            isOpen: false,
            colors: ['Rojo', 'Azul', 'Morado', 'Rosa', 'Verde'],
            values: ['red', 'blue', 'purple', 'pink', 'green'],
            colorSelected: '{{$defaultValueName}}'
        }
    }
</script>