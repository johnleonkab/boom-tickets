...
<div id="toast-default" class="fixed top-24 right-10 flex items-center p-4 w-full max-w-xs rounded-lg shadow text-gray-400 bg-gray-800" role="alert">
...
<script>
  targetEl = document.getElementById('toast-default');
