...
<div id="overlay" class="fixed h-screen w-screen top-0 flex left-0 bg-gray-900 z-40 text-center">
    ...
    <div class="bg-gray-700 rounded-lg text-white p-5 m-5">
        ...
        <form id="event-form" action="{{$postUrl}}" method="POST" enctype="multipart/form-data">
            ...
            <div id="uneditable-content" class="">
                ...
                <button type="submit" id="save-button" class="mt-5 @if($event->slug != '') @endif invisible  rounded-lg font-medium bg-indigo-500 py-2 px-5  hover:bg-indigo-600 active:bg-indigo-700 transition ">
                    Guardar Cambios
                </button>
            </div>
        </form>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
            ...
            <div class="rounded-lg bg-gray-900 p-5">
                ...
                <input id="ticket-name" class="mb-5" name="name" type="text" value="{{$ticket->name}}" @if($event->visible) readonly @endif  placeholder="Nombre" >
            ...
            <div class="rounded-lg bg-gray-800 p-5 border-4 border-dashed border-gray-400">
                <form action="{{url('admin/ticket/update')}}" method="get">
                    <input type="hidden" name="event_slug" value="{{$event->slug}}">
                <label for="ticket-name">Nombre de la entrada</label>
                <input id="ticket-name" class="mb-5" name="name" type="text" placeholder="Nombre" >
                <label for="ticket-description">Condiciones</label>
